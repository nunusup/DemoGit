...
public class employee extends person{
    ...
    public employee(String name, int yearOfbirth, long phoneNumber, String address, String companyName, String rollNumber, int yearOfexperience, int level, int salary1, int salary2) {
